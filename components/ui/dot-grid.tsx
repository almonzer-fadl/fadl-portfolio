...
const DotGrid: React.FC<DotGridProps> = ({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (const dot of dotsRef.current) {
        ...
        const baseColor = isDark ? foreground : muted;
        const activeColor = isDark ? background : foreground;
  ...
  }, [proximity, foreground, background, muted, mutedForeground, isDark, circlePath]);
